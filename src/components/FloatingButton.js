...
function FloatingButton() {
  ...
  return (
    <div className="group fixed bottom-0 right-0 p-12  flex items-end justify-end w-36 h-36 ">
      <div
        class="text-white text-center shadow-lg shadow-button flex items-center justify-center py-5 px-4 rounded-full bg-primary leading-none z-50 absolute cursor-pointer hover:-translate-1 hover:scale-110 "
        onClick={openModal}
      >
        Get<br></br> Demo
        {/* <svg
