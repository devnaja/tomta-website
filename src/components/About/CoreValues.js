        ...
        <div className="w-full draggable">
          <div className="container flex flex-col items-center gap-16 mx-auto">
            <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center gap-3 px-8 py-10 bg-red-50  rounded-3xl shadow-main  transition-all hover:scale-105">
                <span>
                  <svg
                ...
                <p className="text-base leading-7 text-dark-grey-600 text-justify">
