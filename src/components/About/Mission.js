    ...
    <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
      ...
      <div className="mb-16 lg:mb-0 ">
        <div className="max-w-xl bg-white py-10 lg:py-24 px-4 lg:px-10 rounded-3xl m-auto">
          ...
          {/* <p className="text-black text-base md:text-lg leading-relaxed tracking-wider">
            As we harness the potential of technology, we aim to be a beacon of
            positive change, leaving a lasting and meaningful imprint on the
            individuals, businesses, and communities we serve.
          </p> */}
        </div>
      </div>
