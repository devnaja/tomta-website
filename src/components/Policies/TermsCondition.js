    ...
    <div className="tnc grid content-center min-h-screen text-justify px-5 md:px-60 py-5 md:py-10 text-desc">
      <div className="details my-5">
        ...
        <p>
          ...
          use of Tomta's Website, located at https://tomtatechnology.com/.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Tomta if you do not agree to take
        ...
        <p>
          ...
          accordance with and subject to, prevailing law of Malaysia. Any use of
